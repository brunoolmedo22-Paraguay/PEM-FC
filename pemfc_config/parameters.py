...
class PEMFCParameters:
    ...
    xi1: float = -0.674670745
    xi2: float = 0.00177611023
    xi3: float = -7.34060893e-05
    xi4: float = 1.19477362e-05

    # Cadeia ôhmica Eq. (10)-(12), parametrizada pelo R_mem de referência.
    R_mem_ref_ohm_cm2: float = 0.226963516
    R_mem_temperature_exponent: float = -0.761912143
    ...
    concentration_a_ref_V: float = 0.00634107396
    concentration_a_temperature_V_K: float = 1.44790439e-05
    concentration_b_cm2_A: float = 2.95057277
    ...
    fuel_utilization: float = 0.6961520937
